...
public class NotificationHelper {
    ...
    public void createUploadedNotification(UploadtoDB uptodb,ImageResponse response) {
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(mContext.get());
        ...
        uptodb.link1 = response.data.link;
        uptodb.description = response.data.description;
        uptodb.title = response.data.title;
        //new DBconnector().uploadData(uptodb);
    }
